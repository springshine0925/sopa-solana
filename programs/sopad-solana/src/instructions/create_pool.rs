...
pub fn create_pool_handler(ctx: Context<CreatePool>, args: CreatePoolArgs) -> Result<()> {
    ...
    require!(args.max_amount >= args.min_amount, SoPadError::TimeError1);
    require!(args.end_time > args.start_time, SoPadError::TimeError2);
    require!(args.claim_time >= args.end_time, SoPadError::TimeError3);
