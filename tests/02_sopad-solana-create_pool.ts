...
export function getprovider():[anchor.AnchorProvider,Program<SopadSolana>]{
...
describe("sopad-solana init", () => {
  ...
  //   console.log("signer",signer);
  //   // console.log("ifoConfigPDA",ifoConfigPDA);
  //   // console.log("poolConfigPDA",poolConfigPDA);
  //   try {
  //     await program.methods
  //       .createPool({
  //         startTime: new anchor.BN(startTime),
  ...
  //         tn: new anchor.BN(1),
  //         cliff: new anchor.BN(2),
  //         period: new anchor.BN(3),
  //         initialRate: new anchor.BN(1e6),
  //         tokenMint:null,
